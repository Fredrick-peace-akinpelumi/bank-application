...
export default function Dashboard() {
  return (
    ...
    <div className="container-fluid mx-auto">
     ...
     <div className="container col-lg-4 col-sm-12 col-md-6 padd ">
          <div className="row">
   ...
   <div className=" p-5  shadow boxes">
   ...
   <div className="  p-5  shadow ms-1 boxes">
   ...
   <div className=" p-5  shadow ms- boxes">
   ...
   <div className=" p-5  shadow mt-3 boxes">
   ...
   {/*  Third Section*/}
   <div className="container-fluid mx-auto  upp">
      <div className="row">
